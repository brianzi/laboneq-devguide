...
| Pulse functionals and swept pulse parameters | `src/python/laboneq/dsl/experiment/pulse_library.py`, `pulse.py`, `src/python/laboneq/core/utilities/pulse_sampler.py`, `src/rust/laboneq-compiler-py/src/experiment_processor/resolve_pulses.rs`, `src/rust/codegenerator-utils/src/pulse_parameters.rs`, `src/python/laboneq/compiler/seqc/waveform_sampler.py` |
...
| `src/rust/laboneq-compiler-py/src/experiment_processor/resolve_pulses.rs` | pulse-resolution preprocessing | Resolves pulse lengths and validates pulse-parameter usage before timed IR and waveform generation. | [resolve_pulses.rs](https://github.com/zhinst/laboneq/blob/main/src/rust/laboneq-compiler-py/src/experiment_processor/resolve_pulses.rs) |
| `src/rust/codegenerator-utils/src/pulse_parameters.rs` | pulse-parameter keying | Merges definition-level and play-time pulse parameters into stable identifiers used by waveform and pulse-map artifacts. | [pulse_parameters.rs](https://github.com/zhinst/laboneq/blob/main/src/rust/codegenerator-utils/src/pulse_parameters.rs) |
| `src/python/laboneq/core/utilities/pulse_sampler.py` | Python pulse sampling | Samples pulse functionals into real or IQ arrays, applies parameter precedence, marker rules, and amplitude checks. | [pulse_sampler.py](https://github.com/zhinst/laboneq/blob/main/src/python/laboneq/core/utilities/pulse_sampler.py) |
| `src/python/laboneq/compiler/seqc/waveform_sampler.py` | waveform sampling and pulse maps | Turns scheduled pulse parts into sampled waveforms, waveform signatures, and compiled pulse-map entries. | [waveform_sampler.py](https://github.com/zhinst/laboneq/blob/main/src/python/laboneq/compiler/seqc/waveform_sampler.py) |
...
| `src/python/laboneq/dsl/experiment/pulse.py` | Pulse object model | `PulseFunctional`, `PulseSampled`, `pulse_functional`, sampled-pulse helpers | [pulse.py](https://github.com/zhinst/laboneq/blob/main/src/python/laboneq/dsl/experiment/pulse.py) |
| `src/python/laboneq/dsl/experiment/pulse_library.py` | Pulse-library registration and built-ins | `register_pulse_functional`, built-in pulse factories, visualization helpers | [pulse_library.py](https://github.com/zhinst/laboneq/blob/main/src/python/laboneq/dsl/experiment/pulse_library.py) |
